...
import StatusLightningPaymentSent from 'blindmixer-lib/dist/status/lightning-payment-sent';
import StatusInvoiceSettled from 'blindmixer-lib/dist/status/invoice-settled';
